...
int main() {
    printf("\n");
    printf("Step 1: Install Microsoft Visual Studio Code (VS code) and GCC in you system\n");
    ...
    printf("Essential: Open VS Code, click the Extensions icon on the left sidebar, and search for \"C/C++\" by Microsoft (coderunner for code to run in terminal(optional)). Install it.\n\n");
